...
function Exercise() {
  return (
    <div className="fixed top-0 right-0 w-full h-screen bg-mainbg z-10">
      ...
      <div className="inset-0 h-3/4 w-full bg-gradient-to-br from-orange to-pink flex flex-col justify-center">
        <h1 className="flex flex-col justify-center text-center">Excercise</h1>
        ...
        <div className="flex justify-around">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="w-6 h-6 rounded-full bg-greybg"></div>
            <p className="text-xs leading-3 uppercase text-center">6 Wochen</p>
          </div>
        </div>
      </div>
    </div>
